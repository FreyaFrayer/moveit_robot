...
def main() -> int:
    ...
    ap.add_argument("--base-data-root", type=str, default="batch_data", help="Base dir for raw outputs.")
    ap.add_argument("--csv-dir", type=str, default="batch_csv", help="Dir for aggregated CSV outputs.")
    ap.add_argument("--log-dir", type=str, default="batch_logs", help="Dir for per-run ros2 logs.")
